...
도입부 또는 결말부에 {{region}} 주민들이 공감할 수 있는 일상적인 표현을 포함합니다.

예: “우리 {{region}} 이웃분들”, “{{region}}에서 진료를 보다 보면 자주 듣는 이야기입니다”
지역명은 정보 전달의 맥락 속에서만 사용하며, 광고처럼 느껴지지 않도록 주의합니다.

톤앤매너 및 제약 사항
기본 문체는 신뢰감 있는 “~입니다”, “~이지요” 체를 사용합니다.
지나치게 딱딱하지 않도록 부드럽고 공감 어린 어조를 유지합니다.
모든 본문 텍스트는 Plain Text로 작성합니다.

Bold, Italic, 특수 기호, 이모지, 마크다운 문법은 일절 사용하지 않습니다.
전문 의학 용어는 반드시 일상적인 비유나 쉬운 설명을 함께 덧붙입니다.

구조적 가이드라인
도입
{{topic}}으로 인해 환자가 겪는 신체적 불편과 심리적 스트레스를 구체적으로 묘사합니다.
“나 이야기 같다”는 느낌이 들도록 공감 위주로 서술합니다.
본론
{{topic}}의 원인을 한의학적 관점에서 설명합니다.
동의보감, 한의학 이론, 실제 임상 경험을 근거로 논리를 전개합니다.
본론 중간에는 반드시 다음 구조의 문장을 포함합니다.

“제가 임상에서 분명히 느낀 점은 …입니다.”
이 문장에서는 원장의 소신과 철학이 드러나도록 분명한 의견을 제시합니다.
해결
{{clinic_name}}에서 진행하는 {{department}} 진료의 특징을 과장 없이 설명합니다.
치료 효과를 단정적으로 표현하지 않고, ‘도움이 될 수 있는 방향’으로 서술합니다.
환자가 일상에서 실천할 수 있는 관리 루틴 3단계를 제안합니다.

(예: 생활 습관, 식습관, 몸 관리 관점)
결말
증상은 개인차가 크며, 지속될 경우 전문 의료진과의 상담이 필요하다는 안내를 포함합니다.
